...
import { Container, Card, Button, Row, Col, Form as BsForm } from 'react-bootstrap';
import { useNavigate } from 'react-router';
import { createCustomer, getAllCustomerTypes } from '../../service/customerService';
                ...
                <Col md={10} lg={8}>
                    <Card className="shadow-lg border-0 rounded-4">
                        <Card.Header className="bg-premium-gradient text-white text-center py-4 border-0">
                            <h2 className="mb-0 fw-bold">Thêm Mới Khách Hàng</h2>
                                    ...
                                    <Form>
                                        <Row>
                                            <Col md={6} className="mb-4">
                                                ...
                                                <Field name="name" className="form-control form-control-lg border-2" placeholder="Ví dụ: Nguyễn Văn An" />
                                            ...
                                            <Col md={6} className="mb-4">
                                                ...
                                                <div className="d-flex gap-4 mt-2">
                                                    ...
                                                    <BsForm.Check
                                                        ...
                                                        name="gender"
                                                        value="0"
                                                        checked={values.gender === 0 || values.gender === "0"}
                                            ...
                                            <Col md={6} className="mb-4">
                                                ...
                                                <Field name="customerTypeId" as="select" className="form-select form-control-lg border-2 shadow-none shadow-sm">
                                            ...
                                            <Col md={6} className="mb-4">
                                                ...
                                                <Field name="idCard" className="form-control form-control-lg border-2" placeholder="9 hoặc 12 chữ số" />
                                            ...
                                            <Col md={6} className="mb-4">
                                                ...
                                                <Field name="phone" className="form-control form-control-lg border-2" placeholder="090xxxxxxx" />
                                            ...
                                            <Col md={12} className="mb-4">
                                                ...
                                                <Field name="email" type="email" className="form-control form-control-lg border-2" placeholder="example@gmail.com" />
